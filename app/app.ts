...
export const apiInitErrorResultToMessage = (resultCode: obs.EVideoCodes) => {
  switch (resultCode) {
    case obs.EVideoCodes.NotSupported: {
      return 'Failed to initialize FlexTV Broadcaster. Your video drivers may be out of date, or FlexTV Broadcaster may not be supported on your system.';
    }
    ...
    default: {
      return 'An unknown error was encountered while initializing FlexTV Broadcaster.';
    }
  }
};
